...
if __name__ == '__main__':
    ...
    checkpoint_filepath = os.path.join(MODEL_DIR, 'best_model')
    ...
    if fine_tune:
        ...
        fine_tune_checkpoint_filepath = os.path.join(MODEL_DIR, 'best_model_fine_tuned')
